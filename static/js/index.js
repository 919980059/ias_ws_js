...
/* harmony import */ var vconsole__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vconsole */ "./node_modules/_vconsole@3.7.0@vconsole/dist/vconsole.min.js");
...
/* harmony import */ var js_transcode_operate_worker_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! js/transcode-operate.worker.js */ "./src/js/transcode-operate.worker.js");
/* harmony import */ var js_transcode_operate_worker_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(js_transcode_operate_worker_js__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var js_base64__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! js-base64 */ "./node_modules/_js-base64@2.6.4@js-base64/base64.js");
...
var transWorker1 = new js_transcode_operate_worker_js__WEBPACK_IMPORTED_MODULE_5___default.a(); //APPID，APISecret，APIKey在控制台-我的应用-语音听写（流式版）页面获取

var APPID = 'a7a85d71';
var API_SECRET = 'MDdiMDZjYzJkNGY1MTc4Y2U3MjRlZTY3';
var API_KEY = '62dc58bb4e86dd7c41fe7e1fb8bb1ffe';
/**
 * 获取websocket url
  ...
  if (text.includes('你好')) {
    ...
    setTimeout(function () {
      if (['init', 'endPlay', 'errorTTS'].indexOf(ttsRecorder.status) > -1) {
        ttsRecorder.start();
        setTimeout(function () {
          $('#result_output').html("".concat(text, "<br>").concat(res));
        }, 1000);
      } else {
        ttsRecorder.stop();
      }
...
var TTSRecorder = /*#__PURE__*/function () {
  function TTSRecorder() {
    ...
    transWorker1.onmessage = function (e) {
      console.log('ttevent', e);

      if (!Array.isArray(e.data)) {
        var _this5$audioData, _this5$rawAudioData;

        (_this5$audioData = _this5.audioData).push.apply(_this5$audioData, _toConsumableArray(e.data.data));

        (_this5$rawAudioData = _this5.rawAudioData).push.apply(_this5$rawAudioData, _toConsumableArray(e.data.rawAudioData));
      }
    };
  } // 修改录音听写状态
  ...
  _createClass(TTSRecorder, [{
    ...
    value: function connectWebSocket() {
      ...
      return getWebsocketUrl().then(function (url) {
        ...
        ttsWS.onopen = function (e) {
          _this6.webSocketSend();

          _this6.playTimeout = setTimeout(function () {
            _this6.audioPlay();
          }, 1000);
        };

        ttsWS.onmessage = function (e) {
          _this6.result(e.data);
        };

        ttsWS.onerror = function (e) {
          clearTimeout(_this6.playTimeout);

          _this6.setStatus('errorTTS');
    ...
    value: function result(resultData) {
      ...
      transWorker1.postMessage(jsonData.data.audio);
    ...
    value: function audioPlay() {
      ...
      bufferSource.onended = function (event) {
        if (_this7.status !== 'play') {
          return;
        }

        if (_this7.audioDataOffset < _this7.audioData.length) {
          _this7.audioPlay();
        } else {
          _this7.audioStop();
        }
